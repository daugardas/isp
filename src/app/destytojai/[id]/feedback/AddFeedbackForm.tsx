...
import { IvertinimoTipas } from "@prisma/client";
...
export default function AddFeedbackForm({ tutorId }: AddFeedbackFormProps) {
  const [tipas, setTipas] = useState<IvertinimoTipas>(IvertinimoTipas.destytojo);
    ...
    <div className="mt-6 w-8/12 max-w-xs flex flex-col items-center gap-4 dark:bg-gray-800 text-black p-4 rounded-md">
      <Form action={formAction}>
        ...
        <div className="grid grid-cols-2 gap-5">
          <Link href={`/destytojai/${tutorId}`}>Atgal</Link>
